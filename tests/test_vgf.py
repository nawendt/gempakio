...
def test_tracks_v0():
    """Test decoding of storm track (v0) elements."""
    expected_track = {
        'delete': 0,
        'vg_type': 26,
        'vg_class': 10,
        ...
        'lat': np.array(
            [39.7, 39.6, 39.47, 39.35, 39.17, 38.97, 38.76, 38.53, 38.28, 38.01, 37.72, 37.42],
            dtype='>f4',
        ),
        'lon': np.array(
            [
    ...
    vgf = Path(__file__).parent / 'data' / 'tracks_v0.vgf'

    v = VectorGraphicFile(vgf)

    decoded_track = v.get_tracks()[0].__dict__

    np.testing.assert_equal(decoded_track, expected_track)


def test_tracks_v1():
    """Test decoding of storm track (v1) elements."""
    expected_track = {
        'delete': 0,
        'vg_type': 26,
        'vg_class': 10,
        ...
        'lat': np.array([39.46, 39.52, 39.56, 39.6, 39.64, 39.67, 39.69], dtype='>f4'),
        'lon': np.array([-86.32, -85.2, -84.45, -83.62, -82.79, -81.96, -81.13], dtype='>f4'),
    }

    vgf = Path(__file__).parent / 'data' / 'tracks_v1.vgf'
...
def test_watch_v0():
    """Test decoding of watch (v0) box elements."""
    expected_watch = {
        'delete': 0,
        'vg_type': 6,
        'vg_class': 2,
        ...
        'anchor0_lat': -9999.0,
        'anchor0_lon': -9999.0,
        'anchor0_distance': -9999.0,
        'anchor0_direction': '',
        'anchor1_station': '',
        'anchor1_lat': -9999.0,
        'anchor1_lon': -9999.0,
        'anchor1_distance': -9999.0,
        'anchor1_direction': '',
        'status': 0,
        'number': -9999,
        'issue_time': 0,
        ...
        'number_counties': 0,
        'plot_counties': 1,
        'county_fips': np.array([], dtype='>i4'),
        'county_status': np.array([], dtype='>i4'),
        'county_lat': np.array([], dtype='>f4'),
        'county_lon': np.array([], dtype='>f4'),
        'lat': np.array(
            [
                37.252388,
                37.252388,
    ...
    vgf = Path(__file__).parent / 'data' / 'watch_v0.vgf'
...
def test_watch_v1():
    """Test decoding of watch (v1) box elements."""
    expected_watch = {
        'delete': 0,
        'vg_type': 6,
        'vg_class': 2,
        ...
        'status': 1,
        'number': 845,
        'issue_time': '12/12/2001/2145/',
        'expire_time': '12/13/2001/0200/',
        'watch_type': 6,
        'severity': 0,
        'timezone': 'CST',
        'max_hail': '1.0',
        ...
        'county_lon': np.array([], dtype='>f4'),
        'lat': np.array(
            [33.188377, 33.18, 32.26, 31.34, 31.340696, 31.34, 32.26, 33.18, 33.188377],
            dtype='f4',
        ),
        'lon': np.array(
            [
    ...
    vgf = Path(__file__).parent / 'data' / 'watch_v1.vgf'
...
def test_watch_v2():
    """Test decoding of watch (v2) box elements."""
    expected_watch = {
        'delete': 0,
        'vg_type': 6,
        'vg_class': 2,
        ...
        'status': 1,
        'number': 32,
        'issue_time': '02/14/2000/1845/',
        'expire_time': '02/15/2000/0000/',
        'watch_type': 2,
        'severity': 0,
        'timezone': 'CST',
        'max_hail': '2.0',
    ...
    vgf = Path(__file__).parent / 'data' / 'watch_v2.vgf'
...
def test_watch_v3():
    """Test decoding of watch (v3) box elements."""
    expected_watch = {
        'delete': 0,
        'vg_type': 6,
        'vg_class': 2,
        ...
        'anchor0_lon': -86.68,
        'anchor0_distance': 75,
        'anchor0_direction': 'WNW',
        'anchor1_station': 'TUP',
        'anchor1_lat': 34.27,
        'anchor1_lon': -88.77,
        'anchor1_distance': 60,
        'anchor1_direction': 'SE',
        'status': 1,
        'number': 788,
        'issue_time': '10/13/2001/1800/',
        'expire_time': '10/13/2001/2300/',
        'watch_type': 2,
        'severity': 0,
        'timezone': 'CDT',
        'max_hail': '1.0',
        ...
        'mean_storm_speed': '35',
        'mean_storm_direction': '230',
        'states': 'AL AR MO MS TN',
        'adjacent_areas': '',
        'replacing': '786',
        'forecaster': 'IMY',
        'filename': 'ww0788.txt',
        'issue_flag': 1,
        'wsm_issue_time': '131845',
        'wsm_expire_time': '132000',
        'wsm_reference_direction': '',
        'wsm_recent_from_line': (
            '35 WSW HUM TO 25 W MSY TO 40 SSE MCB TO 35 NE MCB TO 20 ESE JAN TO 30 NE JAN'
        ),
        'wsm_md_number': '',
        'wsm_forecaster': 'JEWELL',
        'number_counties': 70,
        'plot_counties': 1,
        'county_fips': np.array([], dtype='>i4'),
        'county_status': np.array(
    ...
    vgf = Path(__file__).parent / 'data' / 'watch_v3.vgf'
...
def test_watch_v4():
    """Test decoding of watch (v4) box elements."""
    expected_watch = {
        'delete': 0,
        'vg_type': 6,
        'vg_class': 2,
        ...
        'anchor0_lon': -90.08,
        'anchor0_distance': 65,
        'anchor0_direction': 'NNE',
        'anchor1_station': 'HEZ',
        'anchor1_lat': 31.62,
        'anchor1_lon': -91.3,
        'anchor1_distance': 50,
        'anchor1_direction': 'ESE',
        'status': 1,
        'number': 845,
        'issue_time': '12/12/2001/2145/',
        'expire_time': '12/13/2001/0200/',
    ...
    vgf = Path(__file__).parent / 'data' / 'watch_v4.vgf'
...
def test_watch_v5():
    ...
    expected_watch = {
        ...
        'anchor0_lon': -81.68,
        'anchor0_distance': 65,
        'anchor0_direction': 'SW',
        'anchor1_station': 'AYS',
        'anchor1_lat': 31.25,
        'anchor1_lon': -82.4,
        'anchor1_distance': 65,
        'anchor1_direction': 'NNE',
        'status': 1,
        'number': 820,
        'issue_time': '12/31/2002/2155/',
        'expire_time': '01/01/2003/0300/',
        'watch_type': 6,
        'severity': 0,
        'timezone': 'EST',
        'max_hail': '1.0',
    ...
    vgf = Path(__file__).parent / 'data' / 'watch_v5.vgf'
